...
\usepackage{xcolor}
\graphicspath{{../results/experiment_0/}{../results/experiment_1/}{../results/experiment_2/}{../results/experiment_3/}{../results/experiment_4/}}
...
Experiment~5 will replace a simulated source with a historical meter export or
API adapter while preserving the canonical contract, storage, and analysis
layers. In parallel, a broader validation campaign should vary demand and
telemetry seeds, anomaly sizes and durations, threshold selection data, and
overlap between physical and sensor faults. A real pilot must also define the
extra evidence required to distinguish leaks from meter errors.
