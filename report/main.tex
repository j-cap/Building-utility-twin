...
\usepackage{xcolor}
\graphicspath{{../results/experiment_0/}{../results/experiment_1/}{../results/experiment_2/}{../results/experiment_3/}{../results/experiment_4/}{../results/experiment_5/}{../results/pilot_p1/}}
...
P2 will build an operator dashboard against the P1 API, beginning with portfolio
health, building and meter views, import status, and evidence-backed anomaly
review. P3 will separate data-quality checks, accounting/plausibility measures,
and diagnostic research into explicit evidence levels. P4 will generalize the
vendor-adapter toolkit, and P5 will package the demonstrator with operational
safeguards.
