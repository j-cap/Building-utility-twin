...
\usepackage{xcolor}
\graphicspath{{../results/experiment_0/}{../results/experiment_1/}{../results/experiment_2/}{../results/experiment_3/}{../results/experiment_4/}{../results/experiment_5/}{../results/pilot_p1/}{../results/pilot_p2/}}
...
P3 will separate data-quality checks, accounting and plausibility measures, and
diagnostic research into explicit evidence levels. It should use the P2 review
queue as the presentation boundary while keeping threshold selection and
diagnostic claims in a test bench. P4 will generalize the vendor-adapter toolkit,
and P5 will package the demonstrator with operational safeguards.
