...
\usepackage{xcolor}
\graphicspath{{../results/experiment_0/}{../results/experiment_1/}}
...
Experiment~2 will introduce meter and communication imperfections: finite
resolution, measurement noise, sparse readout, missing or delayed packets,
register rollover, and reset handling. Experiment~3 will add apartments,
building-level aggregation, and a shared boiler with storage and loss dynamics.
