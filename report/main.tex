...
\usepackage{xcolor}
\graphicspath{{../results/experiment_0/}{../results/experiment_1/}{../results/experiment_2/}{../results/experiment_3/}{../results/experiment_4/}{../results/experiment_5/}}
...
Experiment~6 should replace the representative fixture with an unmodified,
de-identified export from a physical meter system and record export-version,
timezone, counter rollover, missingness, and calibration metadata. A separate
training or baseline period should select thresholds before held-out evaluation.
In parallel, a broader validation campaign should vary demand and telemetry
seeds, anomaly sizes and durations, threshold selection data, and overlap
between physical and sensor faults. A pilot must also define the extra evidence
required to distinguish leaks from meter errors.
